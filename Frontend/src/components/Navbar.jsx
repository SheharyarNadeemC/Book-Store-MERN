...
function Navbar() {
    ...
    return (
        <>
            <div className={`max-w-scrren-2xl container mx-auto dark:bg-slate-900 dark:text-white  md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${
                sticky?"sticky-navbar shadow-md dark:bg-slate-600 dark:text-white bg-pink-100 duration-300 transition-all ease-in-out"
                :""
            }`}>
                ...
                <div className="navbar">
                    <div className="navbar-start">
                        ...
                        <a className="text-2xl font-bold cursor-pointer">Sheharyar's Book Store</a>
                    </div>
